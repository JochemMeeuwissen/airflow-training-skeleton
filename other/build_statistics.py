...
spark.read.json(
    "gs://airflow-training-knab-jochem/land_registry_price_paid_uk/*/*.json"
).withColumn(
...
spark.read.json("gs://airflow-training-knab-jochem/currency/*.json").withColumn(
...
(
    ...
    .parquet("gs://airflow-training-knab-jochem/average_prices/transfer_date={}/".format(dt))
)
